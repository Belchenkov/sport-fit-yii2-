            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="index.html"><img src="/images/home/logo.png" alt="Логотип" /></a>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="#"><i class="fa fa-user"></i> Счет</a></li>
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Каталог<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    <li><a href="product-details.html">Полное описание</a></li>
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                <h1><span>FITNESS</span>-MARKET</h1>
                                <h2>Магазин спортивного питания</h2>
                                <p>Приветствуем любителей фитнесса и здорового образа жизни!</p>
                                <button type="button" class="btn btn-default get">Узменить свое тело</button>
                            </div>
                            <div class="col-sm-6">
...
<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2017 E-FIT Inc. All rights reserved.</p>
